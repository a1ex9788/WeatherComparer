...
public class CustomRecyclerAdapterHourDayForecast extends RecyclerView.Adapter<CustomRecyclerAdapterHourDayForecast.ViewHolder> {
	...
	public CustomRecyclerAdapterHourDayForecast.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		View view = LayoutInflater.from(parent.getContext())
				.inflate(R.layout.bottom_sheet_today_element, parent, false);
		CustomRecyclerAdapterHourDayForecast.ViewHolder holder = new CustomRecyclerAdapterHourDayForecast.ViewHolder(
				view);
		return holder;
	}
	...
	public static class ViewHolder extends RecyclerView.ViewHolder {
		...
		public ViewHolder(View view) {
			super(view);
			this.tvHour = view.findViewById(R.id.tvHour);
			this.tvTemperature = view.findViewById(R.id.tvTemp);
			this.lavWeatherIcon = view.findViewById(R.id.lavWeatherIcon);
		}
