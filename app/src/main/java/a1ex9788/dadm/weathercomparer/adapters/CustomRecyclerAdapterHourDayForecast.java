...
public class CustomRecyclerAdapterHourDayForecast extends
        RecyclerView.Adapter<CustomRecyclerAdapterHourDayForecast.ViewHolder> {

    private final List<HourDayForecast> list;
    ...
    @NonNull
    @Override
    public CustomRecyclerAdapterHourDayForecast.ViewHolder onCreateViewHolder(
            @NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.bottom_sheet_today_element, parent, false);
        CustomRecyclerAdapterHourDayForecast.ViewHolder holder =
                new CustomRecyclerAdapterHourDayForecast.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull CustomRecyclerAdapterHourDayForecast.ViewHolder holder,
            final int position) {
