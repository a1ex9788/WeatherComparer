...
public class UnitsConverterTest {
	...
	public void celsiusToFahrenheit() {
		...
		for (Map.Entry<Double, Double> pair : parameters.entrySet()) {
			assertEquals(
					pair.getValue(),
					UnitsConverter.roundToTwoDecimals(UnitsConverter.celsiusToFahrenheit(pair.getKey())),
					0);
		}
	}
	...
	public void celsiusToKelvin() {
		...
		for (Map.Entry<Double, Double> pair : parameters.entrySet()) {
			assertEquals(
					pair.getValue(),
					UnitsConverter.roundToTwoDecimals(UnitsConverter.celsiusToKelvin(pair.getKey())),
					0);
		}
	}
	...
	public void kilometersPerHourToMilesPerHour() {
		...
		for (Map.Entry<Double, Double> pair : parameters.entrySet()) {
			assertEquals(
					pair.getValue(),
					UnitsConverter.roundToTwoDecimals(UnitsConverter.kilometersPerHourToMilesPerHour(pair.getKey())),
					0);
		}
	}
	...
	public void kilometersPerHourToMetersPerSecond() {
		...
		for (Map.Entry<Double, Double> pair : parameters.entrySet()) {
			assertEquals(
					pair.getValue(),
					UnitsConverter.roundToTwoDecimals(UnitsConverter.kilometersPerHourToMetersPerSecond(pair.getKey())),
					0);
		}
	}
	...
	public void metersPerSecondToKilometersPerHour() {
		...
		for (Map.Entry<Double, Double> pair : parameters.entrySet()) {
			assertEquals(
					pair.getValue(),
					UnitsConverter.roundToTwoDecimals(UnitsConverter.metersPerSecondToKilometersPerHour(pair.getKey())),
					0);
		}
	}
